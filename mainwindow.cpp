...
QWidget* MainWindow::makeTopBar() {
    ...
    style += expath;
    style += "images/btnMusicUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnMusicDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnMusicUpGlow.png); background-repeat: no-repeat; border:none;}";
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnVideosUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnVideosDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnVideosUpGlow.png); background-repeat: no-repeat; border:none;}";
...
>>>>>>> aace901267549f03cc40792dd4270ea43b26f0b3
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnRepeatUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnRepeatDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnRepeatUpGlow.png); background-repeat: no-repeat; border:none;}";
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnShuffleUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnShuffleDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnShuffleUpGlow.png); background-repeat: no-repeat; border:none;}";
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnPreviousUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnPreviousDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnPlayUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnPlayDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnPlayUpGlow.png); background-repeat: no-repeat; border:none;}";
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnNextUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnNextDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    ...
    style = "QPushButton { background-image: url(";
    style += expath;
    style += "images/btnMuteUp.png); background-repeat: no-repeat; border:none;} QPushButton:pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnMuteDown.png); background-repeat: no-repeat; border:none;} QPushButton:hover:!pressed {";
    style += "background-image: url(";
    style += expath;
    style += "images/btnMuteUpGlow.png); background-repeat: no-repeat; border:none;}";
